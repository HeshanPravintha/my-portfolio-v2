...
const Experience = () => {
  return (
    <section
      id="experience"
      className="py-16 sm:py-24 bg-secondary-bg relative overflow-hidden"
    >
          ...
          <div className="space-y-12">
            {experience.map((exp, index) => (
              ...
              >
                ...
                >
                  <div className="bg-primary-bg/80 backdrop-blur-md p-4 sm:p-6 rounded-xl border border-white/5 shadow-lg hover:border-accent-1/30 transition-colors group">
