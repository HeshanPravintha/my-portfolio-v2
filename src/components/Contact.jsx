...
const Contact = () => {
  return (
    <section
      id="contact"
      className="py-20 sm:py-32 bg-secondary-bg flex items-center justify-center text-center relative overflow-hidden"
    >
      ...
      >
        ...
        <p className="text-text-secondary text-sm sm:text-base md:text-lg mb-8 sm:mb-10 leading-relaxed">
        ...
        <a
          ...
          className="inline-block px-7 py-3 sm:px-10 sm:py-4 border-2 border-accent-1 text-accent-1 font-bold rounded-md hover:bg-accent-1/10 transition-all duration-300 transform hover:-translate-y-1 shadow-lg hover:shadow-accent-1/20"
        >
          Say Hello
        </a>
      </motion.div>
