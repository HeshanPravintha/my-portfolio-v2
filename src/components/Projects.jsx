...
const Projects = () => {
  return (
    <section id="projects" className="py-20 sm:py-32 bg-primary-bg">
      <div className="container mx-auto px-4 sm:px-6 lg:px-12">
        <SectionTitle>Some Things I've Built</SectionTitle>

        <div className="flex flex-col gap-16 sm:gap-24 mt-12 sm:mt-20">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="w-full lg:w-2/5 flex flex-col items-start relative z-20">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold text-text-primary mb-4 sm:mb-6 hover:text-accent-1 transition-colors cursor-pointer">
                  {project.title}
                </h3>

                {/* Description Box - Updated to support list */}
                <div className="bg-secondary-bg p-4 sm:p-6 rounded-md shadow-xl border border-white/5 mb-6 hover:shadow-2xl transition-shadow">
                  ...
                  {project.liveLink && (
                    ...
                    >
                      <FaExternalLinkAlt
                        ...
                        className="group-hover:scale-110 transition-transform"
                      />
                      <span>{project.liveLinkLabel || "Live Demo"}</span>
                    </a>
                  )}
                </div>
              </div>
